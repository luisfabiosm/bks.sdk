...
//        // Iniciar span de tracing
//        using var _span = _tracer.StartSpan($"HTTP {context.Request.Method} {GetNormalizedPath(context.Request.Path)}");

//        // Adicionar tags ao span
//        AddSpanTags(context, _span);
...
//            // Completar rastreamento de performance
//            performanceTracker.Complete();

//            // Adicionar informações de conclusão ao span
//            AddCompletionInfoToSpan(context, _span, stopwatch.Elapsed);
//        }
//        catch (Exception ex)
//        {
//            stopwatch.Stop();
...
//            // Completar rastreamento com erro
//            performanceTracker.Complete(ex);

//            // Registrar exceção no span
//            _span.RecordException(ex);
//            _span.SetStatus(SpanStatus.Error, ex.Message);

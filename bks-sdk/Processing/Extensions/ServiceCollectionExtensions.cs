...
public static class ServiceCollectionExtensions
{
    ...
    {
        // Registrar mediator
        services.AddScoped<IMediator, Mediator.BKSMediator>();

        // Registrar processador do mediator
        services.AddScoped(typeof(IMediatorProcessor<,>), typeof(BKSMediatorProcessor<,>));
    ...
    public static IServiceCollection AddBKSFrameworkTransactionProcessor(this IServiceCollection services)
    {
        ...
        services.AddScoped(typeof(ITransactionProcessor<,>), typeof(TransactionProcessor<,>));
    ...
    private static void RegisterTransactionProcessors(IServiceCollection services)
    {
        ...
        foreach (var assembly in assemblies)
        {
            ...
            foreach (var processorType in processorTypes)
            {
                ...
                var interfaceType = typeof(ITransactionProcessor<,>).MakeGenericType(genericArgs);
